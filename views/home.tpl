...
<h1 class="Title">BigDickChan</h1>
<div class="Boards">
  <h2 class="Boards-title">Witaj</h2>
  <p id="welcome">Cześć, społeczności BickDickChanu! Witam was serdecznie i życzę pełnych inspiracji dyskusji oraz świetnej zabawy! 🌟</p>
</div>
<div class="Boards">
